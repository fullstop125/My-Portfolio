...
let cardData = [
  {
    title: 'Tonic1', imag: 'tonic-project-2.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
  ...
  {
    title: 'Tonic2', imag: 'Snapshoot_Portfolio.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tags: ['html', 'css', 'javascript'],
    seeLive:'https://fullstop125.github.io/My-Portfolio/',
  ...
  {
    title: 'Tonic3', imag: 'tonic-project-2.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tags: ['html', 'css', 'javascript'],
    seeLive:'https://fullstop125.github.io/My-Portfolio/',
  ...
  {
    title: 'Tonic4', imag: 'Snapshoot_Portfolio.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tags: ['html', 'css', 'javascript'],
    seeLive:'https://fullstop125.github.io/My-Portfolio/',
  ...
  {
    title: 'Tonic5', imag: 'tonic-project-2.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tags: ['html', 'css', 'javascript'],
    seeLive:'https://fullstop125.github.io/My-Portfolio/',
  ...
  {
    title: 'Tonic6', imag: 'Snapshoot_Portfolio.png',
    role: 'Canopy', clientName: 'Back End Dev',
    clientYear: '2015', projectDescription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tags: ['html', 'css', 'javascript'],
    seeLive:'https://fullstop125.github.io/My-Portfolio/',
